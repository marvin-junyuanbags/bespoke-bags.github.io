// Bespoke Bags - Main JavaScript File
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    const fadeElements = document.querySelectorAll('.service-card, .product-card, .blog-card, .about-content');
